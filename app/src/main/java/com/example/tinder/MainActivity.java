...
public class MainActivity extends AppCompatActivity {
   ...
   /* public MainActivity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                //change opposite sex user V11 it have
            ...
            public void onRightCardExit(Object dataObject) {
                cards obj = (cards) dataObject;
                String userId = obj.getUserId();
                // the below line also changed opposite sex use in child
    ...
    private void isConnectionMatch(String userId) {
        ...
        currentUserConnectionDb.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    //here also change user sex and opposite sex user in child
    ...
    public  void checkUserSex() {
        ...
        DatabaseReference userDb = usersDb.child(user.getUid());//locn of the db
